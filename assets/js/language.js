...
function updateTranslations() {
    ...
    // 更新小型语言切换按钮文本
    const langToggleMini = document.getElementById('languageToggleMini');
    if (langToggleMini) {
        const langTextMini = document.getElementById('languageTextMini');
        if (langTextMini) {
            langTextMini.textContent = currentLang === 'zh' ? '中/EN' : 'EN/中';
            console.log('Updated mini language toggle button text');
        }
    }
